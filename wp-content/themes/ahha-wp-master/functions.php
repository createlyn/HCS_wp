...
//     // /*----Intro Home Text widget---*/
//     // register_sidebar( array(
//     // 'name'          => ('Intro Home Text'),
//     // 'id'            => '',
//     // 'description'   => 'Intro Home Text',
//     // 'before_widget' => '<div>',
//     // 'after_widget'  => '</div>',
//     // 'before_title'  => '<h2>',
//     // 'after_title'   => '</h2>'
...
/*----Nav Text widget---*/
register_sidebar( array(
    'name'          => ('Intro About Text'),
    'id'            => 'about-intro',
    'class'         => 'about__content',
    'description'   => 'Intro about Text',
    'before_widget' => '<div class="columns-4__s columns-7__m offset-1__m columns-5__l offset-1__l">',
    'after_widget'  => '</div>',
    // 'before_title'  => '<h2>',
    // 'after_title'   => '</h2>'
    ));
